...
class UserControllerRestAssuredIT {
    ...
    void findAll_ReturnsAllUsers_WhenArgumentIsNull() throws Exception {
        ...
        var expectedResponse = fileUtils.readResourceFile("user/get-user-null-first_name-200.json");
    ...
    void findAll_ReturnsFoundUserInList_WhenFirstNameIsFound() throws Exception {
        ...
        var expectedResponse = fileUtils.readResourceFile("user/get-user-william-first_name-200.json");
    ...
    void findAll_ReturnsEmptyList_WhenFirstNameIsNotFound() throws Exception {
        ...
        var expectedResponse = fileUtils.readResourceFile("user/get-user-x-first_name-200.json");
        var firstName = "x";
    ...
    void findById_ReturnsUserById_WhenSuccessful() throws Exception {
        ...
        var expectedResponse = fileUtils.readResourceFile("user/get-user-by-id-1-200.json");
        var users = repository.findByFirstNameIgnoreCase("William");
    ...
    void delete_ThrowsNotFound_WhenUserIsNotFound() throws Exception {
        ...
        var expectedResponse = fileUtils.readResourceFile("user/delete-response-user-404.json");
        var id = 99L;
    ...
    void update_UpdatesUser_WhenSuccessful() throws Exception {
        ...
        var users = repository.findByFirstNameIgnoreCase("Darryl");
        ...
        Assertions.assertThat(passwordEncoder.matches("super", encryptedPassword)).isTrue();
    }
